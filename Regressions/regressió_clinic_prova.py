...
#PROVA DE LASSO SENSE GROUP LASSO BINARITZANT ABANS DE SPLIT (PER FER FINS AL FINAL)
...
dummies_pathology = pandas.get_dummies(clinical_data['Pathology']).drop(['No biopsy'], axis=1)
...
clinical_data = pandas.concat([clinical_data, dummies_hepatitis,dummies_pathology,dummies_tumor_nodul], axis = 1)
clinical_data = clinical_data.drop(columns=['tumor_nodul','hepatitis','Pathology'])
#=======================================================================================================================
