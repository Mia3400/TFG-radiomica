...
radiomic_data = pandas.read_csv("C:/Users/miacr/TFG-radiomica/feature_data.csv")
...
for var1, var2 in correlated_vars:
    corr_val = high_corr.loc[var2, var1]
    if var1 in data.columns and var2 in data.columns:
        data = data.drop(var1, axis = 1)
        #print(var1)
    #print(f"{var1}, {var2} tenen {corr_val:.2f} correlació")
data.info()
#Separació:
...
Lasso_reg= Lasso(alpha=3, random_state=42)
